        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Categories_Localizations_CategoryNameId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GategoryId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_Localizations_DescriptionId",
                        column: x => x.DescriptionId,
                        principalTable: "Localizations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Products_Localizations_ProductNameId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductAttributes_Localizations_NameId",
                        column: x => x.NameId,
                        principalTable: "Localizations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductAttributes_Localizations_ValueId",
                        column: x => x.ValueId,
                        principalTable: "Localizations",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductOptions_Localizations_DescriptionId",
                        column: x => x.DescriptionId,
                        principalTable: "Localizations",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProductOptions_Localizations_NameId",
                        column: x => x.NameId,
                        principalTable: "Localizations",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductAttributes_NameId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductOptions_DescriptionId",
                table: "ProductOptions",
                column: "DescriptionId");

            migrationBuilder.CreateIndex(
                name: "IX_ProductOptions_NameId",
                table: "ProductOptions",
                column: "NameId");
